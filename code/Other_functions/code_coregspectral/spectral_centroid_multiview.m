function [F P R nmi avgent AR C] = spectral_centroid_multiview(X,num_views,numClust,sigma,lambda,truth,numiter)
%[Fc Pc Rc nmi_cm2 avgent_cm AR_cm  idx_cm] = spectral_centroid_multiview(data_set33,num_views,CCC,sigma_c, 0.01*ones(1,num_views),true_labs,30);
